...
import ru.yakubov.vote.util.exception.*;
...
import static ru.yakubov.vote.util.exception.ErrorType.*;
...
public class ExceptionInfoHandler {
    ...
    public static final String EXCEPTION_DUPLICATE_DATE = "exception.meal.duplicateDate";

    private static final Map<String, String> CONSTRAINS_I18N_MAP = Map.of(
            "users_unique_email_idx", EXCEPTION_DUPLICATE_EMAIL,
            "votes_unique_user_date_idx", EXCEPTION_DUPLICATE_DATE);
